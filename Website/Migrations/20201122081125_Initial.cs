        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hinh2 = table.Column<string>(nullable: true),
                    Hinh3 = table.Column<string>(nullable: true),
                    Hinh4 = table.Column<string>(nullable: true),
                    Hinh5 = table.Column<string>(nullable: true),
...
";
    ...
    BEGIN TRY
        BEGIN TRANSACTION
        INSERT INTO KhachHang(HoTen, SoDienThoai, Email, MatKhau, DangHoatDong, MaNgauNhien) VALUES(N'Quản trị Hệ thống', '0909009990', 'admin@gmail.com','{matKhau.ToSHA512Hash(randomKey)}', 1, '{randomKey}')
